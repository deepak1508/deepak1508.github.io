...
self.addEventListener("install",function(b){self.skipWaiting();console.log("CT Service worker installed")});
...
var a=JSON.parse(b.data.text()),c=a.title,d=a.notificationOptions,f=d.data,e;
console.log(a);
"undefined"!==typeof f&&(e=f.wzrk_id);"undefined"===typeof e&&(e=c);
localforage.setItem(e,b.data.text()).then(function(a){})["catch"](function(a){console.log("Error in persisting")});globalRedirectPath=a.redirectPath;globalNotificationData=a;a=a.raiseNotificationViewedPath;"undefined"!==typeof a&&fetch(a,{mode:"no-cors"});b.waitUntil(self.registration.showNotification(c,
    d))});
