...
self.addEventListener("install",function(b){self.skipWaiting();
	console.log("CT Service worker installed")});
self.addEventListener("activate",function(b){console.log("CT Service worker activated")});
self.addEventListener("push",function(b){console.log("Push event: ",b);
...
globalRedirectPath=a.redirectPath;globalNotificationData=a;
...
function onClick(b,a,c){
	var d=!0;
	"action1"===b.action?("undefined"!==typeof c.notificationOptions.actions[0].deepLink&&(a+="&r="+encodeURIComponent(c.notificationOptions.actions[0].deepLink),d=!1),
		a+="&b="+encodeURIComponent("button1")):"action2"===b.action?("undefined"!==typeof c.notificationOptions.actions[1].deepLink&&(a+="&r="+encodeURIComponent(c.notificationOptions.actions[1].deepLink),
			d=!1),
		a+="&b="+encodeURIComponent("button2")):("undefined"!==typeof c.deepLink&&(a+="&r="+encodeURIComponent(c.deepLink),d=
